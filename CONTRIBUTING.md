# Contributing to Pimcore Bundle Generator
...
* [Open an issue](https://github.com/pimcore/bundle-generator/issues) here on GitHub. 
...
* Please be patient as not all items will be tested immediately - remember, Pimcore Bundle Generator is open source and free of charge. 
...
* Code! Follow the coding standards defined [here](https://github.com/pimcore/bundle-generator/blob/master/.php_cs.dist).
* [Send a pull request](https://help.github.com/articles/using-pull-requests/) from your fork’s branch to our `master` branch.
* [Sign the CLA](https://cla-assistant.io/pimcore/bundle-generator) - see also below.
